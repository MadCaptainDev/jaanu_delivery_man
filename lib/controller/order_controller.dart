...
import 'package:jaanu_delivery_man/data/model/body/record_location_body.dart';
import 'package:jaanu_delivery_man/data/model/body/update_status_body.dart';
import 'package:jaanu_delivery_man/data/model/response/ignore_model.dart';
import 'package:jaanu_delivery_man/data/model/response/order_details_model.dart';
import 'package:jaanu_delivery_man/data/model/response/order_model.dart';
import 'package:jaanu_delivery_man/data/repository/order_repo.dart';
...
class OrderController extends GetxController implements GetxService {
  ...
  void removeFromIgnoreList() {
    ...
    _tempList.addAll(_ignoredRequests as Iterable<IgnoreModel>);
