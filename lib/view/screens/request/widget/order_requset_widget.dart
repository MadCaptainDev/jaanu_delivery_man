...
import 'package:jaanu_delivery_man/helper/price_converter.dart';
...
class OrderRequestWidget extends StatelessWidget {
  ...
  OrderRequestWidget({required this.orderModel,
    required this.index,
    required this.onTap,
        ...
        return Column(children: [
              ...
              child: ClipRRect(
                  ...
                  child: CustomImage(
                    image: _parcel
                        ...
                        .configModel
                        .baseUrls!
                        .parcelCategoryImageUrl}/${orderModel!.parcelCategory !=
                        null ? orderModel!.parcelCategory!.image : ''}'
                        : '${Get
                        .find<SplashController>()
                        .configModel
                        .baseUrls!
                        .storeImageUrl}/${orderModel!.storeLogo ?? ''}',
          ...
          Container(
            ...
            child: Text(
              _parcel
                  ? 'parcel'.tr
                  : '${orderModel!.detailsCount} ${orderModel!.detailsCount! > 1
                  ? 'items'.tr
                  : 'item'.tr}',
              style: robotoMedium.copyWith(
                  fontSize: Dimensions.FONT_SIZE_SMALL,
          ...
          // Text(
          //   '${(DateConverter.timeDistanceInMin(orderModel!.createdAt!) % 60).toString().padLeft(2, '0')} ${'mins_ago'.tr}',
                      ...
                      Get.dialog(
                          ConfirmationDialog(
                            ...
                            onYesPressed: () {
                              ...
                              Get.back();
                              showCustomSnackBar(
                                  'order_ignored'.tr, isError: false);
                            },
                          ),
