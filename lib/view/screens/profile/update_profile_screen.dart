...
import 'package:jaanu_delivery_man/view/base/my_text_field.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<AuthController>(builder: (authController) {
        ...
        // print("Picked File ${authController.pickedFile}");
        // print(authController.pickedFile);
        ...
        if (authController.profileModel != null) {
          return ProfileBgWidget(
                ...
                circularImage: Center(
                  ...
                  ClipOval(
                      child: (authController.pickedFile !=null && authController.pickedFile !="")
                          ? Image.memory(
