...
import 'package:jaanu_delivery_man/controller/localization_controller.dart';
...
import 'package:jaanu_delivery_man/view/base/custom_button.dart';
...
import 'package:jaanu_delivery_man/view/screens/order/widget/order_item_widget.dart';
import 'package:jaanu_delivery_man/view/screens/order/widget/verify_delivery_sheet.dart';
import 'package:jaanu_delivery_man/view/screens/order/widget/info_card.dart';
import 'package:jaanu_delivery_man/view/screens/order/widget/slider_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    bool? _restConfModel =
        Get.find<SplashController>().configModel.orderConfirmationModel !=
            'deliveryman';
    bool? _showBottomView = (_parcel && _accepted) ||
        _accepted ||
        _confirmed ||
        _processing ||
        _handover ||
          ...
          return orderController.orderDetailsModel != null
              ? Column(children: [
                    ...
                    child: Column(children: [
                      ...
                      InfoCard(
                        ...
                        address: _parcel
                            ...
                            : DeliveryAddress(
                                address: orderModel!.storeAddress),
                        image: _parcel
                            ? ''
                  ...
                  _showBottomView
                      ? ((_accepted &&
                                  !_parcel &&
                                  (!_cod || _restConfModel || _selfDelivery)) ||
                              _processing ||
                              _confirmed)
                          ? Container(
                              padding: EdgeInsets.all(
                                            ...
                                            Get.bottomSheet(
                                                VerifyDeliverySheet(
                                                  ...
                                                  verify: Get.find<
                                                      ...
                                                      .orderDeliveryVerification!,
                                                  orderAmount:
                                                  (orderModel!.orderAmount!+orderModel!.totalTaxAmount!),
                                                  cod: _cod,
                                                ),
